...
import ab from '../../assets/images/cover.webp'
      ...
      <div className='max-w-7xl bg-base-100  px-5  md:mx-10'>
        <section className="bg-base-100" id="demo">
          <div className="py-24 max-md:px-8 max-w-3xl mx-auto">
            <div className="relative max-sm:-mx-8 ">
              <div className="max-lg:hidden absolute top-1/4 -left-4 -translate-x-full text-sm flex flex-col gap-1 items-center">
                <p className="text-base-content/80"></p><svg className="w-12 h-12 fill-base-content/80" viewBox="0 0 130 130" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="relative w-full aspect-video overflow-hidden sm:rounded">
                <Image className="object-cover object-center xl:h-[28rem] rounded-xl"
                  src={ab}
                  alt=""
                  width={800}
                  height={600}
