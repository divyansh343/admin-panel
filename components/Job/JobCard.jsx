        ...
        <div className='lg:col-span-8 md:col-span-6'>
          <div className="group relative overflow-hidden lg:flex justify-between items-center rounded  py-3">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-xl hover:text-emerald-600 font-bold transition-all duration-500 ms-3 ml-3 min-w-[150px]">{item.job_title}</p>
                <p className="text-md hover:text-emerald-600 transition-all duration-500 ms-3 ml-3 min-w-[150px]"><MdLocationCity className='inline-block text-primary mr-1 animate-pulse' />{item.business_name}</p>
